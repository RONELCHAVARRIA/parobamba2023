...
!function(e,t,a,n,o){"use strict";var i=function(e){return e*(1-2*Math.random())};e.fn.skin=function(o){o=e.extend({},e.fn.skin.defaults,o);var s,r,l,d,c,u,h,p,f,m=e(this).eq(0),g="animatics_skin",v=e("[data-audioplayer]"),w=v.length&&!v.data(o.pausedClass),y=getTranslations({newItem:"NEW",atFirstPage:"At first page",atLastPage:"At last page",atLastPageQuestion:"Where to go next?",startOver:"Start over",backToHome:"Back to home",upOneLevel:"Up one level",previousFolder:"Previous folder",nextFolder:"Next folder",download:"Download",print:"Print",metaBtn:"Photo data",clickToOpen:"Click to open this document with the associated viewer!"}),C={prev:"jprev",next:"jnext",cards:"cards",card:"card",caption:"caption",title:"title",hasCaption:"hascaption",imageReady:"imageready",prevPage:"prevpg",nextPage:"nextpg",currPage:"currpg",threedee:"threedee"},b=e("#lightbox"),k=e("#thumbnails"),T=e("#thumbnails .thumb-cont"),P=T.find(".thumb"),x=e("#controls"),F=e("#lbcontrols"),N=e("#panels"),M=(e("#navigation"),e("#numbers")),A=0,S=0,D=1,O=!1,I=new Date-1e4,E="",q=!1,L=new Date/1e3,U=null,z=null,H=null,W=null,R=!1,j=!1,B=function(e){if(e)for(var t=0;t<P.length;t++)if(P.eq(t).attr("href").getFile()===e)return t;return-1},X=function(){if(window.location.hash!==E){E=window.location.hash;var e=readParam();if(e.hasOwnProperty("img")){var t=B(e.img);t>=0?ge(t):removeParam(o.indexName,"img"),V()}}},Q=function(e,t){var a=P.eq(typeof t===UNDEF?A:t).data("vars"),n=e.split(",");if(a&&(a=a.type))for(var o=0;o<n.length;o++)if(n[o]===a)return!0;return!1},V=function(){o.hasOwnProperty("share")&&b.is(":visible")&&e(o.share.hook).trigger("updateLinks")},K=function(){var e=k.outerHeight(),a=(k.position().top,t.height()-N.position().top),n=x.find("[data-rel=thumbnails]").position().top;k.css("top",Math.minMax(0,a-e,n))},_=function(){H=clearTimeout(H),m.removeClass(o.controlsHideClass)},Y=function(){o.hideControls&&(H=clearTimeout(H),N.children(".on").length||(x.add(F).hideAllTooltips(),m.addClass(o.controlsHideClass)))},$=function(){"mouse"===whatInput.ask("intent")&&(j||"mouse"===whatInput.ask("intent")&&(a.on("mousemove."+g,function(){m.hasClass(o.controlsHideClass)&&_(),$()}),j=!0),clearTimeout(H),H=setTimeout(Y,W?Math.min(o.slideshowDelay/2,1e3*o.hideControls):1e3*o.hideControls))},G=function(t,a){t.each(function(){var t=e(this),n=this.id,o=!1;e("#controls [data-rel="+n+"]").removeClass("on"),t.hideAllTooltips(),t.one("transitionend",function(t){o||(o=!0,e(this).removeClass("on").css("display","none"),typeof a===FUNCTION&&a.call(null))}).css({transition:"all 500ms ease-out",opacity:0,transform:"translateX(-16px)"})})},J=function(){G(N.children(".on"))},Z=function(t,a,n){var i,s,r,l,d=m.hasClass("thumbs-left")||m.hasClass("thumbs-right"),c=d?T.height():T.width(),u=e();typeof t===UNDEF||typeof t===FUNCTION?(i=d?T.scrollTop():T.scrollLeft(),typeof t===FUNCTION&&(typeof a===FUNCTION&&(n=a),a=t)):i=t,T.find("a."+o.lazyloadClass).filter(function(){var t=e(this).position()[d?"top":"left"]+i;return t+c/2>=0&&t-2*c<=0}).each(function(){if(!(s=e(this)).children("img").length){var t=s.data("vars"),a=t.thumbWidth,i=t.thumbHeight,d=a/i;(l=t.thumb)&&(r=e("<img>",{class:o.hideImageClass+" "+(d>=1.25?"landscape":d<=.8?"portrait":"square")}).one("load",function(){e(this).addClass(o.showImageClass).removeClass(o.hideImageClass),e(this).parent().removeClass(o.lazyloadClass),typeof n===FUNCTION&&n.call()}).attr({width:a,height:i,alt:t.title||l.stripExt(),src:pe(s,[s.outerWidth(),s.outerHeight()])}).appendTo(s),u.append(r))}}),typeof a===FUNCTION&&(u.length?u.waitAllImg(a):a.call())},ee=function(e){return s.children("[data-rel="+e+"]")},te=function(){J(),m.removeClass(o.pausedClass).addClass(o.playingClass),!o.auto&&o.backgroundAudioSlideshowControl&&v.trigger("fadeInPlayer"),W=clearTimeout(W),o.auto=!0,requestWakeLock(),W=setTimeout(we,p.delay/4)},ae=function(){o.auto&&o.backgroundAudioSlideshowControl&&v.trigger("fadeOutPlayer"),m.removeClass(o.playingClass).addClass(o.pausedClass),W=clearTimeout(W),o.auto=!1,releaseWakeLock()},ne=function(){R=!1,W=setTimeout(we,p.delay/4),o.backgroundAudioSlideshowControl&&v.trigger("fadeInPlayer"),m.removeClass(o.pausedClass).addClass(o.playingClass)},oe=function(t){o.auto?(m.removeClass(o.playingClass).addClass(o.pausedClass),o.backgroundAudioSlideshowControl&&v.trigger("fadeOutPlayer"),R=!0,W=clearTimeout(W)):o.muteBackgroundAudio&&(w=!v.data(o.pausedClass))&&v.trigger("fadeOutPlayer"),e(this).closest("."+o.cardClass).addClass(o.playingClass)},ie=function(t){o.auto?ne():o.muteBackgroundAudio&&w&&v.trigger("fadeInPlayer"),e(this).closest("."+o.cardClass).removeClass(o.playingClass)},se=function(){var e=typeof e===UNDEF?A:e,t=ee(e),a=t.length?t.find("video,audio")[0]:null;if(a)if(a.paused){var n=a.play();n&&n.catch(function(e){console.log("Autoplay has prevented by the browser. "+e),a.muted||(a.muted=!0,n=a.play())})}else a.pause()},re=function(){w=!1,o.auto&&ne()},le=function(){var t=b.width()-2*o.fitPadding,a=b.height()-2*o.fitPadding;b.removeClass("landscape portrait").addClass(t>=a?"landscape":"portrait"),s.children().each(function(){var n=e(this),i=n.data("rel");if(null!==i&&i>=0&&i<P.length){var s,r=P.eq(i);if(r.length&&(s=r.data("vars"))){var l=s.width,d=s.height,c=s.type,u=1;"none"===o.scaling||"other"===c?(l>t||d>a)&&(u=Math.min(t/l,a/d)):u="fit"===o.scaling||"video"===c||"audio"===c?Math.min(o.maxScale,Math.min(t/l,a/d)):Math.min(o.maxScale,Math.max(t/l,a/d)),l*=u,d*=u,n.css({transition:"all .2s linear",width:Math.round(l),height:Math.round(d),left:Math.round((t-l)/2)+o.fitPadding,top:Math.round((a-d)/2)+o.fitPadding})}}})},de=function(){var t=ee(S),a=P.eq(A).data("vars").type||"image",n=A!==S?ee(A):e(),r=function(){return[t.outerWidth()||s.width(),t.outerHeight()||s.height()]};switch(s.removeClass("bwd fwd"),D&&s.addClass(D>0?"fwd":"bwd"),e(".map-root").trigger("resetMarkers"),t.addClass(C.imageReady),s.data("ts",new Date),n.destroyAllTooltips(),P.length>1&&t.swipe({onSwipedLeft:function(e){we()},onSwipedRight:function(){ve()},onSwipeStart:function(){ae()},onClick:function(e){return m.hasClass("hide-controls")?(_(),!1):!o.clickForNext||"BUTTON"===e.target.nodeName||"A"===e.target.nodeName||(ae(),we(),!1)},onFinished:function(){e(this).data("rel")!==A&&e(this).remove()}}),n.data("scrolling")&&(n=e()),o.transitionType){case"crossfade":n.length?(t.css({opacity:0}).css({transition:"opacity "+p.adaptiveSpeed+"ms ease-in-out"}).css({opacity:1}),t.one("transitionend",fe),n.one("transitionend",function(){e(this).remove()}).css({transition:"opacity "+p.adaptiveSpeed+"ms ease-in-out"}).css({opacity:0})):t.show().css({opacity:1,transition:"opacity "+p.adaptiveSpeed+"ms ease-in-out"});break;case"zoom":var l=function(){t.show().css({transform:"scale("+(D>0?.9:1.11)+")",opacity:0}),n.one("transitionend",function(){e(this).remove()}).css({opacity:0,transform:"scale("+(D>0?1.11:.9)+")",transition:"transform "+p.adaptiveSpeed+"ms ease-out, opacity "+p.adaptiveSpeed+"ms ease-in-out"}),window.requestAnimationFrame(d)},d=function(){t.css({transition:"transform "+p.adaptiveSpeed+"ms ease-out, opacity "+p.adaptiveSpeed+"ms ease-in-out"}).css({transform:"scale(1)",opacity:1}),t.one("transitionend",fe)};window.requestAnimationFrame(l);break;case"stack":var c=r(),u=((T=i(60))+90)/180*Math.PI,h=Math.min(c[0],c[1])/4;l=function(){t.css({transition:"all "+p.adaptiveSpeed+"ms ease-out, opacity "+p.adaptiveSpeed/2+"ms linear",opacity:0,transform:"scale(0.92)"}),n.css({transition:"all "+p.adaptiveSpeed/2+"ms ease-in, opacity "+p.adaptiveSpeed/2+"ms ease-in",opacity:1}),window.requestAnimationFrame(d)},d=function(){t.css({transform:"scale(1)",opacity:1}),t.one("transitionend",fe),n.one("transitionend",function(){e(this).remove()}).css({opacity:0,transform:"rotate("+(0-T/10)+"deg) translate("+Math.round(h*Math.cos(u))+"px,"+D*Math.round(0-h*Math.sin(u))+"px)"})},window.requestAnimationFrame(l);break;case"kenburns":var g,v,w,c=r(),y=t.children("img,video,audio,object").eq(0),k=t.children(".caption"),T=i(1)*Math.PI,h=(Math.random()+.2)*Math.min(c[0],c[1])*.08,x=Math.round(h*Math.cos(T)),F=Math.round(h*Math.sin(T)),N=b.width(),M=b.height(),l=function(){t.css({transition:"none",transform:"scale("+g+")  translate("+x+"px,"+F+"px)",opacity:0}),"top"!==f[1]&&"bottom"!==f[1]||(w=(c[1]-M/v)/2)>0&&k.css(f[1],w),"left"!==f[0]&&"right"!==f[0]||(w=(c[0]-N/v)/2)>0&&k.css(f[0],w),window.requestAnimationFrame(d)},d=function(){t.show().css({transition:"all "+p.adaptiveSpeed+"ms cubic-bezier(0.39, 0.575, 0.565, 1)",transform:"scale("+v+") translate(0,0)",opacity:1}),t.one("transitionend",fe),n.length&&n.css({transition:"all "+p.adaptiveSpeed+"ms cubic-bezier(0.47, 0, 0.745, 0.715)",transform:"scale("+n.data("sc")+") translate("+n.data("dx")+"px,"+n.data("dy")+"px)",opacity:0}).one("transitionend",function(){e(this).remove()})};"img"===y[0].nodeName?(g=1.14+i(.2),v=g>1.14?g-.1:g+.1):(g=1.1,v=1),t.data({sc:g>1.14?g-.2:g+.2,dx:-x,dy:-F}),window.requestAnimationFrame(l)}o.auto&&!R&&"video"!==a&&"audio"!==a&&(clearTimeout(W),W=setTimeout(we,p.delay+p.speed)),me(),A=S,s.children("."+o.currClass).removeClass(o.currClass),t.addClass(o.currClass),V()},ce=function(e){var t=[];return"["===e[0]&&(e=e.slice(1,-1)),e.split(/,\s?/).forEach(function(e){(e=e.match(/(.+) \((\d+)x(\d+)\)/))&&e.length>3&&t.push([e[1],e[2],e[3]])}),t},ue=function(e,t){var a=(t=typeof t===UNDEF?[n.width(),n.height()]:t)[0]*PIXELRATIO,o=t[1]*PIXELRATIO;return e&&e.length>1&&(WEBP_LOSSY||(e=e.filter(function(e){return!e[0].endsWith(".webp")})),e.forEach(function(e){var t=Math.min(a/e[1],o/e[2]);e[3]=t>1?3*(1-1/t):1-t}),e.sort(function(e,t){return e[3]-t[3]})),e[0][0]},he=function(e,t){var a=e.data("vars");return a&&a.hasOwnProperty("imageRenditions")?o.slidesDir+"/"+ue(ce(a.imageRenditions),typeof t===UNDEF?[n.width(),n.height()]:t):e.attr("href")},pe=function(e,t){var a=e.data("vars");return a?a.hasOwnProperty("thumbRenditions")?o.thumbsDir+"/"+ue(ce(a.thumbRenditions),typeof t===UNDEF?o.thumbDims:t):o.thumbsDir+"/"+a.thumb:e.attr("src")},fe=function(t){var a=typeof t!==UNDEF&&t.hasOwnProperty("target")?e(t.target).data("rel"):A;!function(e){Q("video,audio",e)&&(o.videoAuto?function(e){var e=typeof e===UNDEF?A:e,t=ee(e),a=t.length?t.find("video,audio")[0]:null;a&&("VIDEO"===a.nodeName?playVideo(a):a.play())}(S):function(e){var e=typeof e===UNDEF?A:e,t=ee(e),a=t.length?t.find("video,audio")[0]:null;a&&a.pause()}(S))}(a),e(".map-root").trigger("setActive",a)},me=function(){var e,t;if(D<0&&A>0?e=P.eq(A-1):A<P.length-2&&(e=P.eq(A+1)),e&&(t=he(e))){(new Image).src=t}},ge=function(t){var a=new Date;if(m.hideAllTooltips(),!(t<0||t>=P.length||a-I<200)){if(S=t,D=function(e){e=typeof e===UNDEF?S:e;if(O){if(A===P.length-1&&0===e)return 1;if(!A&&e===P.length-1)return-1}return e===A?0:e>A?1:-1}(),p.adaptiveSpeed=Math.minMax(p.speed/5,a-I,p.speed),I=a,A!==S||s.is(":empty"))!function(){var t=e(),a=function(){!function(a){var n,i,r,l,d,c,u,h,p,f,m,g,v=b.width()-2*o.fitPadding,w=b.height()-2*o.fitPadding,C=0,k=O?(a+P.length)%P.length:a;if((n=ee(k)).length||(n=e("<div>",{id:"card_"+a,"data-rel":k,class:o.cardClass})),k>=0&&k<P.length)if((l=n.children("img,video,object")).length)"VIDEO"===l[0].nodeName&&l[0].pause();else{switch(r=P.eq(k),f=r.data("vars"),m=f.type,n.addClass(m),u=C=f.width,h=p=f.height,g=1,"none"===o.scaling||"other"===m?(C>v||p>w)&&(g=Math.min(v/C,w/p)):g="fit"===o.scaling||"video"===m||"audio"===m?Math.min(o.maxScale,Math.min(v/C,w/p)):Math.min(o.maxScale,Math.max(v/C,w/p)),C*=g,p*=g,n.css({width:Math.round(C),height:Math.round(p),left:Math.round((v-C)/2)+o.fitPadding,top:Math.round((w-p)/2)+o.fitPadding}),m){case"image":l=e("<img>").attr({width:u,height:h,alt:r.find("img").attr("alt")||""}).one("load",function(t){e(this).addClass(o.loadedClass)}).attr("src",he(r,[C,p])).appendTo(n);break;case"video":l=e("<video>").one("loadedmetadata",function(t){e(this).addClass(o.loadedClass)}).attr({controls:!0,controlslist:"nodownload nofullscreen",disablePictureInPicture:!0,width:u,height:h,type:"video/mp4",src:f.original}).on("play",oe).on("pause",ie).on("ended",re).appendTo(n);break;default:l=e("<img>").attr({width:u,height:h}).one("load",function(t){e(this).addClass(o.loadedClass)}).attr("src",f.thumb).appendTo(n)}if(c=e("<div>",{class:o.buttonsClass}),o.printImage&&"image"===m&&!o.rightClickProtect&&e("<a>",{class:"btn icon-printer",title:y.print}).on("click",function(e){return printImage(f.original&&o.showDownload?f.original:r.attr("href"),(f.original||r.attr("href")).getFile()||"",f.caption||""),!1}).appendTo(c),"other"===m||o.showDownload&&("image"===m||o.allowDownloadOthers)){var T=f.original;!T&&o.allowDownloadScaled&&(T=r.attr("href")),T&&e("<a>",{class:"btn icon-download",download:"",href:T,title:y.download}).appendTo(c)}f.photodata&&e("<a>",{class:"btn icon-camera meta"}).appendTo(c).data("tooltip",'<div class="photodata">'+f.photodata+"</div>"),c.is(":empty")&&!f.caption||(d=e("<div>",{class:o.captionClass+" "+o.captionStyle+" "+o.captionPlacement}).appendTo(n),f.caption&&e(f.caption).addClass("text").appendTo(d),c.is(":empty")||(d.append(c),c.children().addTooltip({touchToggle:!0}))),o.rightClickProtect&&l.on("contextmenu",function(e){return e.preventDefault(),!1}),t=t.add(l)}else n.addClass("blank").show(),n.find("img").addClass(o.loadedClass);a===S?(i=ee(a+1)).length?i.before(n):(i=ee(a-1)).length?i.after(n):s.append(n):a<S?(i=ee(a+1)).length?i.before(n):s.prepend(n):(i=ee(a-1)).length?i.after(n):s.append(n)}(S),t.length?1===t.length?t.one("load loadedmetadata",de):t.waitAllImg(de):de()};window.requestAnimationFrame(function(){window.requestAnimationFrame(a)})}();else{ee(A).css({transition:"transform 300ms ease-out, opacity 300ms linear",transform:"translateX(0)",opacity:1})}!function(e){P.removeClass(o.activeClass).eq(typeof e!==UNDEF?e:A).addClass(o.activeClass)}(S),function(e){var t=P.eq(e),a=t.attr("href").getFile();addParam(o.indexName,{img:a},t.attr("title")||a.stripExt())}(S),o.showNumbers&&function(e){M.length&&M.html("<big>"+e+"</big><small>"+P.length+"</small>")}(S+1)}},ve=function(){if(J(),o.hideControls&&$(),A)ge(A-1);else switch(ae(),o.afterLast){case"donothing":case"onelevelup":case"ask":ae();break;case"nextfolder":ae(),o.previousFoldersLast?window.location.href=o.previousFoldersLast:ge(0);break;case"startover":return void ge(P.length-1)}},we=function(){if(J(),o.hideControls&&$(),A<P.length-1)ge(A+1);else switch(o.afterLast){case"donothing":ae();break;case"startover":return void ge(0);case"onelevelup":ae(),o.level&&(window.location.href="../"+o.indexName);break;case"nextfolder":var t=o.auto;ae(),o.nextFoldersFirst?window.location.href=o.nextFoldersFirst+(t?"&slideshow":""):ge(P.length-1);break;case"ask":ae();var a=new Array;return P.length>1&&a.push({t:y.startOver,c:"icon-loop",h:function(e){ge(0)}}),o.level&&a.push({t:y.upOneLevel,c:"icon-one-level-up",h:function(){window.location.href="../"+o.indexName}}),o.nextFoldersFirst&&a.push({t:y.nextFolder,c:"icon-arrow-right",h:function(){window.location.href=o.nextFoldersFirst}}),void m.modal(e("<p>",{class:"text-center",text:y.atLastPageQuestion}),a,{onClose:function(){ge(P.length-1)},class:"secondary",title:y.atLastPage})}};return function(){if(window.location.search&&removeSearch(),function(t){t.length&&(e.fn.audioPlayer.defaults.rootPath=o.rootPath,t.audioPlayer())}(v),o.hasOwnProperty("share")&&function(t){e.fn.renderShares.defaults.buttonTheme=t.buttonTheme||"dark",e.fn.renderShares.defaults.indexName=o.indexName,e.fn.renderShares.defaults.facebookAppId=t.facebookAppId||"",t.hasOwnProperty("callAction")&&(e.fn.renderShares.defaults.callAction=t.callAction),e(t.hook).renderShares(t)}(o.share),t.on("hashchange."+g,X),window.location.hash){var n=window.location.hash.match(/img=([^&]+)/);n&&(-1!==(A=B(n[1]))?(q=!0,o.auto=!!window.location.hash.match(/\&slideshow$/)):A=0)}!function(){var t=null;o.showFullscreen&&(u=F.find(".fullscreen.btn"),h=F.find(".windowed.btn"),hasFullscreen()?(u.on("click."+g,function(){requestFullscreen(function(){m.addClass(o.fullscreenClass)})}),h.on("click."+g,function(){exitFullscreen(function(){m.removeClass(o.fullscreenClass)})})):(u.hide(),h.hide())),x.find(".nav-icon").on("click",function(){clearTimeout(t),x.hasClass("active")?(J(),x.addClass("remove").removeClass("active"),t=setTimeout(function(){x.removeClass("remove")},o.transTime),m.removeClass("controls-on")):(x.addClass("active").removeClass("remove"),m.addClass("controls-on"))}),x.add(F).find("[data-rel]").each(function(){var t=e(this);e("#"+t.data("rel")).length?t.addClass("has-panel").on("selectstart."+g,function(e){return e.preventDefault(),!1}).on("click."+g,function(){if(x.hasClass("active")){var t=e(this),a=e("#"+t.data("rel"));return a.hasClass("on")?G(a):(J(),function(e,t){var a=e[0].id,n=x.add(F).find("[data-rel="+a+"]:visible"),o=function(){e.one("transitionend",function(){e.data("finished")||(e.data("finished",!0),window.requestAnimationFrame(i))}).css({transition:"all 500ms ease-out",opacity:1,transform:"translateX(0)"})},i=function(){var o=n.data("autoclose");o&&e.add(n).on("mouseenter."+g,function(){e.data("over",!0),clearTimeout(e.data("fade"))}).on("mouseover."+g,function(){e.data("over",!0)}).on("mouseleave."+g,function(){clearTimeout(e.data("fade")),e.data("over",!0),e.data("fade",setTimeout(function(){e.data("over")||(clearTimeout(e.data("fade")),G(e))},o))}),"thumbnails"===a&&Z(K,K),typeof t===FUNCTION&&t.call(null)};clearTimeout(e.data("fade")),window.requestAnimationFrame(function(){n.add(e).addClass("on"),e.css({transition:"none",display:"flex",opacity:0,transform:"translateX(-16px)"}),"thumbnails"===a?K():e.css({top:n.position().top}),e.data("finished",!1),window.requestAnimationFrame(o)})}(a)),!1}return!0}):t.removeAttr("data-rel")})}(),k.length&&function(){var t,a,n=o.hasOwnProperty("markNew")?L-o.markNew.days*ONEDAY_S:null;P.each(function(o){e(this).data("rel",o).on("click",function(t){return"SPAN"!==t.target.nodeName&&(k.hideAllTooltips(),G(k),ge(e(this).data("rel"))),!1}),"mouse"===whatInput.ask("intent")&&e(this).addTooltip(),n&&(t=e(this).data("vars").date)&&t>=n&&(a=e("<span>",{class:"icon-new new-image"}).appendTo(e(this)),"mouse"===whatInput.ask("intent")&&a.data("tooltip",new Date(1e3*t).toLocaleDateString()).addTooltip())}),o.rightClickProtect&&T.on("contextmenu","img",function(e){return e.preventDefault(),!1}),T.on("scroll."+g,function(){clearTimeout(z),z=setTimeout(Z,100)})}(),o.hasOwnProperty("map")&&o.hasOwnProperty("map")&&(e(".map-root").addMap({markers:function(){var t=[];return P.each(function(a){var n=e(this).data("vars");typeof n!==UNDEF&&n.hasOwnProperty("location")&&t.push({title:[a+1+".",e(this).attr("title")].join(" "),pos:n.location,link:a})}),t}(),type:o.map.type||"roadmap",zoom:o.map.zoom||16,apiKey:o.map.apiKey,fitBounds:!0,fullscreenControl:!1,onMarkerClick:function(){this.hasOwnProperty("link")&&ge(this.link)}}),e("#map-btn").on("click",function(){e(".map-root").data("rendered")||setTimeout(function(t){t.hasClass("on")&&e(".map-root").trigger("render")},20,e(this))})),b.length&&(function(){if(b.data("settings")&&e.extend(setting,b.data("settings")),(s=b.find("."+o.cardsClass)).length||(s=e("<div>",{class:o.cardsClass}).appendTo(b)),f=o.captionPlacement.split(" "),p=o.defaults[o.transitionType||"kenburns"],o.hasOwnProperty("transitionSpeed")&&(p.speed=o.transitionSpeed),o.hasOwnProperty("slideshowDelay")&&(p.delay=o.slideshowDelay),o.hasOwnProperty("fillHorz")&&(p.fillHorz=o.fillHorz/100),o.hasOwnProperty("fillVert")&&(p.fillVert=o.fillVert/100),O="startover"===o.afterLast,1===P.length?p.after=p.before=0:(p.after=Math.min(p.after,Math.ceil(P.length/2)),p.before=Math.min(p.before,Math.floor(P.length/2))),o.enableMouseWheel){var n=null;b.on("mousewheel."+g+" DOMMouseScroll."+g,function(e){return n=clearTimeout(n),n=setTimeout(e.originalEvent.wheelDelta>0||e.originalEvent.detail<0?ve:we,100),!1})}P.length>1&&((r=F.find(".previous")).on("click."+g,ve),(d=F.find(".play")).on("click."+g,te),(c=F.find(".pause")).on("click."+g,ae),(l=F.find(".next")).on("click."+g,we)),"mouse"===whatInput.ask("intent")&&e("#lbcontrols [data-tooltip]").addTooltip({delay:1e3,stay:2e3,pos:[1,2,1,0]}),o.enableKeyboard&&a.on("keyup."+g,function(e){if(!m.length||b.children(".modal:visible").length||document.activeElement&&("INPUT"===document.activeElement.nodeName||"TEXTAREA"===document.activeElement.nodeName))return!0;switch(e.preventDefault(),e.keyCode){case 10:case 13:G(k);break;case 33:case 37:ve();break;case 34:case 39:we();break;case 97:case 35:ge(P.length-1);break;case 103:case 36:ge(0);break;case 106:case 179:W?ae():te();break;case 32:Q("video,audio")?se():W?ae():te();break;default:return!0}return!1}),t.on("resize."+g,function(){clearTimeout(U),U=setTimeout(le,100)})}(),ge(A)),"mouse"===whatInput.ask("intent")&&e("#controls [data-tooltip]").addTooltip({delay:1e3,stay:2e3,pos:[0,1,2,1]}),o.auto&&b.length&&P.length>1&&te()}(),this},e.fn.skin.defaults={activeClass:"active",lazyloadClass:"lazyload",thumbsDir:"thumbs",slidesDir:"slides",indexName:"index.html",cardsClass:"cards",cardClass:"card",currClass:"curr",prevClass:"prev",nextClass:"next",loadedClass:"loaded",captionClass:"caption",buttonsClass:"buttons",hideImageClass:"hide-image",showImageClass:"show-image",fullscreenClass:"fullscreen",controlsHideClass:"hide-controls",playingClass:"playing",pausedClass:"paused",transTime:500,clickForNext:!0,backgroundAudioSlideshowControl:!1,muteBackgroundAudio:!0,videoAuto:!1,videoLoop:!1,volume:.5,auto:!1,afterLast:"donothing",rightClickProtect:!1,allowDownloadOthers:!1,hideControls:0,showNumbers:!0,transitionType:"kenburns",captionStyle:"dark",captionPlacement:"center bottom",showFullscreen:!0,enableKeyboard:!0,enableMouseWheel:!0,scaling:"fit",maxScale:1.5,fitPadding:0,defaults:{kenburns:{before:1,after:0,delay:0,speed:4e3},crossfade:{before:1,after:0,delay:1e3,speed:2e3},zoom:{before:1,after:0,delay:1e3,speed:2e3},stack:{before:1,after:0,delay:1e3,speed:2e3}},fit:"both"}}(jQuery,jQuery(window),jQuery(document),jQuery("body"));
